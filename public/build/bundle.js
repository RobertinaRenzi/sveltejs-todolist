...
var app = (function () {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			attr_dev(li, "class", li_class_value = "todo-item " + (/*todo*/ ctx[8].checked ? "done" : ""));
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*todoItems*/ 1 && input_id_value !== (input_id_value = /*todo*/ ctx[8].id)) {
    				attr_dev(input, "id", input_id_value);
    			}

    			if (dirty & /*todoItems*/ 1 && label_for_value !== (label_for_value = /*todo*/ ctx[8].id)) {
    				attr_dev(label, "for", label_for_value);
    			}

    			if (dirty & /*todoItems*/ 1 && t2_value !== (t2_value = /*todo*/ ctx[8].text + "")) set_data_dev(t2, t2_value);

    			if (dirty & /*todoItems*/ 1 && li_class_value !== (li_class_value = "todo-item " + (/*todo*/ ctx[8].checked ? "done" : ""))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(39:6) {#each todoItems as todo (todo.id)}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function deleteTodo(id) {
    		$$invalidate(0, todoItems = todoItems.filter(item => item.id !== Number(id)));
    	}
